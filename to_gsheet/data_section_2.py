...
def section2(frequency: int, types: int):
    '''
    frequency: 0 for annual, 1 for quarterly
    types: 0 for IIP, 1 for BOP
    '''
    ...
    for k, v in path_dict.items():
        df_path.append(os.path.join(directory_path, k, v[frequency]))
        print(v[frequency]) ## to check the file name
    ...
    if frequency == 1 and types == 1:
        ...
        df_init_tw = pd.read_excel(r"C:\Users\AhmadAizudeen\OneDrive - The SOUTH-EAST ASIAN CENTRAL BANKS (SEACEN) RESEARCH AND TRAINING\Desktop\NLP Project\cfm-nlp\Automation.xlsx", sheet_name=sht_name)
